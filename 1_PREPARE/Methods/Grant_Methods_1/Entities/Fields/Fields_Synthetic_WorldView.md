...
class FieldsWorldView:
    def __init__(self):
        ...
        self.key_concepts = {
            "information_realism": "The view that information is the most fundamental aspect of reality, more fundamental than matter or energy.",
            "observer_dependence": "The idea that reality is fundamentally shaped by the act of observation and cannot be separated from the observer.",
            "active_inference": "A framework explaining how all systems, including minds, interact with and model their environment through prediction and error minimization.",
            "free_energy_principle": "A unifying principle explaining the behavior of all self-organizing systems through the minimization of free energy.",
            "semantic_information": "The idea that information is inherently meaningful and relational, forming the basis of reality.",
            "quantum_cognition": "The application of quantum mechanical principles to understanding cognition and consciousness.",
            "embodied_cognition": "The view that cognitive processes are deeply rooted in the body's interactions with the world.",
            "predictive_processing": "The idea that perception and cognition are fundamentally predictive processes, constantly refining models of the world.",
            "measurement_problem": "The fundamental issue in quantum mechanics regarding the nature of measurement and observation, potentially linked to consciousness.",
            "context_dependence": "The crucial role of context in determining meaning and reality, emphasizing that information has no meaning without context.",
