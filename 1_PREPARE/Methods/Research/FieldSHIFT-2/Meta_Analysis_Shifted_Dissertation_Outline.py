...
class DissertationOutlineMetaAnalysis:
    def __init__(self, input_dir='Inputs_and_Outputs/Shifted_Domain_Dissertation_Outline/', output_dir='./Inputs_and_Outputs/Analyses/Dissertation_Outlines/'):
        logging.info("Initializing DissertationOutlineMetaAnalysis")
...
if __name__ == "__main__":
    analyzer = DissertationOutlineMetaAnalysis()
