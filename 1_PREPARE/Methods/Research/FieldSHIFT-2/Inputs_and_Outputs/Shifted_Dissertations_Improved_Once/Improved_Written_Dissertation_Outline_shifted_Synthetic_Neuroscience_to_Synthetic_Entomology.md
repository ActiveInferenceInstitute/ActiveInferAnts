...
To operationalize these questions, the research will also formulate testable hypotheses that extend the current understanding of both neural networks and insect behavior.
